...
public class TableAuthManager {
  ...
  private ConcurrentSkipListMap<FullyQualifiedTableName, PermissionCache<TablePermission>> tableCache =
      new ConcurrentSkipListMap<FullyQualifiedTableName, PermissionCache<TablePermission>>();
  ...
  public void refreshCacheFromWritable(FullyQualifiedTableName table,
   ...
   * @param tablePerms
   */
  private void updateTableCache(FullyQualifiedTableName table,
  ...
  private PermissionCache<TablePermission> getTablePermissions(FullyQualifiedTableName table) {
  ...
  private boolean authorize(List<TablePermission> perms,
                            FullyQualifiedTableName table, byte[] family,
  ...
  public boolean authorize(User user, FullyQualifiedTableName table, KeyValue kv,
      Permission.Action action) {
  ...
  private boolean authorize(List<TablePermission> perms, FullyQualifiedTableName table, KeyValue kv,
      Permission.Action action) {
    if (perms != null) {
      for (TablePermission p : perms) {
   ...
   * @return true if known and authorized, false otherwise
   */
  public boolean authorizeUser(String username, FullyQualifiedTableName table, byte[] family,
      Permission.Action action) {
   ...
   * @return true if known and authorized, false otherwise
   */
  public boolean authorizeGroup(String groupName, FullyQualifiedTableName table, byte[] family,
      Permission.Action action) {
    // global authorization supercedes table level
  ...
  public boolean authorize(User user, FullyQualifiedTableName table, byte[] family,
      byte[] qualifier, Permission.Action action) {
  ...
  public boolean matchPermission(User user,
      FullyQualifiedTableName table, byte[] family, Permission.Action action) {
    PermissionCache<TablePermission> tablePerms = tableCache.get(table);
    if (tablePerms != null) {
      List<TablePermission> userPerms = tablePerms.getUser(user.getShortName());
      if (userPerms != null) {
  ...
  public boolean matchPermission(User user,
      FullyQualifiedTableName table, byte[] family, byte[] qualifier,
      Permission.Action action) {
    PermissionCache<TablePermission> tablePerms = tableCache.get(table);
    if (tablePerms != null) {
      List<TablePermission> userPerms = tablePerms.getUser(user.getShortName());
   ...
   * @param perms
   */
  public void setUserPermissions(String username, FullyQualifiedTableName table,
   ...
   * @param perms
   */
  public void setGroupPermissions(String group, FullyQualifiedTableName table,
      List<TablePermission> perms) {
    PermissionCache<TablePermission> tablePerms = getTablePermissions(table);
  ...
  public void writeToZooKeeper(FullyQualifiedTableName table,
