...
class FSHLog implements HLog, Syncable {
   ...
   * @return New log key.
   */
  protected HLogKey makeKey(byte[] encodedRegionName, FullyQualifiedTableName tableName, long seqnum,
   ...
   * @throws IOException
   */
  private long append(HRegionInfo info, FullyQualifiedTableName tableName, WALEdit edits, UUID clusterId,
  ...
  @Override
  public long appendNoSync(HRegionInfo info, FullyQualifiedTableName tableName, WALEdit edits,
